 ...
 * 图片裁减库
 *
 * 官方Git地址： https://github.com/Yalantis/uCrop
 */
public class MainActivity extends AppCompatActivity {
    ...
    public void start(View view){
        //需要裁剪的图片路径
        Uri sourceUri = Uri.fromFile(new File(Environment.getExternalStorageDirectory() , "123456.jpg"));
//        Log.d("xiazhenjie","sourceUri=" +sourceUri);
        ...
        UCrop.of(sourceUri, destinationUri) //定义路径
                ...
                .withMaxResultSize(800, 800) //定义裁剪图片宽高最大值
                .start(this);
    }
